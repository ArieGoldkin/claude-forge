...
├── plugins/
│   ├── continuity-toolkit/     # Session continuity management (v2.17.1, installed as ctk)
...
│   └── engineering-toolkit/    # Engineering practices, quality, architecture, cmux fleet orchestration (v2.18.0, installed as etk)
