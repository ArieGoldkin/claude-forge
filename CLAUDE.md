...
├── plugins/
│   ├── continuity-toolkit/     # Session continuity management (v2.7.3, installed as ctk)
...
│   └── engineering-toolkit/    # Engineering practices, quality, architecture (v2.11.0, installed as etk)
