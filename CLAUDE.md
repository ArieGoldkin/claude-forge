...
│   └── engineering-toolkit/    # Engineering practices, quality, architecture (v2.15.1, installed as etk)
...
|--------|--------|--------|----------|-------|-------|
| ctk (formerly continuity-toolkit) | 11 | 1 | 12 | 36 (32 **shared** + 4 ctk-specific) | Session persistence, context monitoring, web research, shared hook owner |
...
| Plugin | Hooks | Notes |
|--------|-------|-------|
| ctk | All 32 shared hooks + 4 ctk-specific (hipaa-context-injector, phi-output-redactor, sandbox-reaper, session-loader) | Canonical shared hooks owner |
