...
├── plugins/
│   ├── continuity-toolkit/     # Session continuity management (v2.11.0, installed as ctk)
...
│   └── engineering-toolkit/    # Engineering practices, quality, architecture (v2.16.2, installed as etk)
