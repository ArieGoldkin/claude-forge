...
| **[ftk](plugins/frontend-toolkit/)** — Frontend Toolkit | 2.3.7 | 17 · 4 · 11 | **Close the design-to-code gap.** React and shadcn/ui components, Figma and Google Stitch AI import, json-render generative UI, design-system tokens, headless browser automation, and Remotion explainer videos — prototype to production. |
